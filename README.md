...
```toml
orchard = { version = "1.3.0-alpha.1", package = "zakura-orchard", git = "https://github.com/zakura-core/common.git", rev = "1929e9f745f58e20404e91dea2b73d743f6aaf73" }
```
...
zakura-wallet-lib = { version = "0.1.0-rc5", default-features = false, features = ["lrz"] }
```
...
```toml
zcash_client_backend = { version = "0.1.0-rc5", package = "zakura-client-backend" }
zcash_client_sqlite = { version = "0.1.0-rc5", package = "zakura-client-sqlite" }
