...
pub use types::{
    ...
    EnhanceRecordParts, ITEM_SIZE_BITS, NETWORK, POOL, PROTOCOL_REVISION, RECORD_BYTES,
    RECORDS_PER_ROW, ROW_BYTES, SCHEMA_VERSION, SHARD_POSITIONS, SHARD_ROWS, SHARDS_PER_GROUP,
    SHARDS_PER_WORKER, ShardDescriptor, group_index_for_shard,
};
