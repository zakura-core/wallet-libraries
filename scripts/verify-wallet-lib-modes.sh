...
check_mode zakura-pir-enhance "$forbidden" \
  "a crates.io original entered the Zakura Enhance PIR build:"
...
for consumer in ("lrz", "zakura", "zakura-default"):
    ...
    if consumer == "zakura":
        drifted_1_2 = {
            ...
            and package["version"].startswith("1.2.0")
            and package["version"] != "1.2.0"
        }
        if drifted_1_2:
            failures["non-stable Zakura 1.2 packages"] = drifted_1_2
