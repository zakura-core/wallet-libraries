...
mod initial_setup;
mod ironwood_enhance_outgoing_queue;
...
pub mod ids {
    pub use super::{
        ...
        ironwood_enhance_outgoing_queue::MIGRATION_ID as IRONWOOD_ENHANCE_OUTGOING_QUEUE,
...
>(
    ...
    vec![
        ...
        Box::new(ironwood_enhance_outgoing_queue::Migration),
...
pub const CURRENT_LEAF_MIGRATIONS: &[Uuid] = &[
    ...
    add_transparent_receiver_address_index::MIGRATION_ID,
    add_transparent_value_index::MIGRATION_ID,
    ironwood_enhance_outgoing_queue::MIGRATION_ID,
